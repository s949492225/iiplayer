...
public class GlRender implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener{
    ...
    private OnGlSurfaceViewCreateListener onGlSurfaceViewCreateListener;
    ...
    public void setOnGlSurfaceViewCreateListener(OnGlSurfaceViewCreateListener onGlSurfaceViewCreateListener) {
    ...
    private void initMediacodecShader()
    {
        ...
        if(onGlSurfaceViewCreateListener != null)
        {
            onGlSurfaceViewCreateListener.onGlSurfaceViewOncreate(surface);
        }
    }
